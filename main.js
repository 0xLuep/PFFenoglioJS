...
/* Botones de filtrado de Productos */
...
function cargarProductos(selectProducts) {
    ...
    selectProducts.forEach(producto => {
        ...
        /* Hover and Click - Agregar al Carrito! - Effect */
        ...
        /* Agrego el Evento de agregar el producto al carrito y el Toastify */
...
/* Listar Productos del carrito en el menu del carrito */
function cargarProductosOnCarr() {
    if (prodOnCarr && prodOnCarr.length > 0) {
        ...
        prodOnCarr.forEach(prod => {
            ...
            // Agregamos el evento de eliminar el producto al boton "Quitar"
            const removeProdButt = div.querySelector(".remove-prod-butt");
            removeProdButt.addEventListener("click", removeProdCarr);
            
            // Agregamos el evento de sumar un producto al botón "+" (y el effect)
            ...
            // Agregamos el evento de restar un producto al botón "-" (y el effect)
...
function removeProdCarr(e) {
    Toastify({
        ...
        style: {
            background: "red",
            "box-shadow": "0px 0px 10px 3px inset rgba(255, 255, 255, 0.75)",
            "border-radius": "20px"
        },
        offset: {
            x: '10px',
...
function buyButtF() {
    Toastify({
        ...
        style: {
            color: "black",
            background: "yellow",
            "box-shadow": "0px 0px 10px 5px inset white",
